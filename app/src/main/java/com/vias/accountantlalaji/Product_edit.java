...
public class Product_edit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences pref3 = getApplicationContext().getSharedPreferences("newProData", 0); // 0 - for private mode
        newProData = pref3.getString("newProData", "");

        ProNameET = (EditText)findViewById(R.id.ProNameET1);
        ProNameET.setText(getIntent().getStringExtra("model_name"));

        ProSpeciET = (EditText)findViewById(R.id.ProSpeciET);
        ProSpeciET.setText(getIntent().getStringExtra("model_specialization"));

        ProMOPET = (EditText)findViewById(R.id.ProMOPET);
        ProMOPET.setText(getIntent().getStringExtra("model_mop_new"));

        ProPPET = (EditText)findViewById(R.id.ProPPET);
        ProPPET.setText(getIntent().getStringExtra("model_mop"));
        ProBarcodeET = (EditText)findViewById(R.id.ProBarcodeET);
        ProBarcodeET.setText(getIntent().getStringExtra("bar_code"));
        ...
        if (img!=null && !img.isEmpty() && !img.equals("") && !img.equals("null")){
            Picasso.with(Product_edit.this)
                    //.load("http://posbooks.com/images/01.jpg")
                    .load(img)
                    .config(Bitmap.Config.RGB_565)
                    .error(R.drawable.gicon)
                    .into(proImage);
        }
        ...
        final ArrayAdapter<String> arrayAdapter_agec = new ArrayAdapter<String>(Product_edit.this,
                android.R.layout.simple_dropdown_item_1line, cateList);

        final MaterialBetterSpinner materialDesignSpinner_agec = (MaterialBetterSpinner)findViewById(R.id.ProCateName);
        ...
        final ArrayAdapter<String> arrayAdapter_ageh = new ArrayAdapter<String>(Product_edit.this,
        ...
        final ArrayAdapter<String> arrayAdapter_u = new ArrayAdapter<String>(Product_edit.this,
        ...
        final ArrayAdapter<String> arrayAdapter_c = new ArrayAdapter<String>(Product_edit.this,
        ...
        final ArrayAdapter<String> arrayAdapter_age = new ArrayAdapter<String>(Product_edit.this,
        ...
        materialDesignSpinner_age.setText("Active");
        ...
        String result = pref.getString("newProData","");
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (ppEt != null && !ppEt.isEmpty() && !ppEt.equals("null")) {
                    if (HSNStr != null && !HSNStr.isEmpty() && !HSNStr.equals("null")) {
                        ...
                        Toast.makeText(Product_edit.this, "Select HSN",Toast.LENGTH_LONG ).show();
                    }
                }
            }
    ...
    private class EditProductgory extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            progressDialog = new ProgressDialog(Product_edit.this);
        ...
        protected String doInBackground(String... strings) {
            ...
            String url = getString(R.string.editproduct);
            String auth = getString(R.string.auth_key);
            String json = jp.editProductJsonFromURL(url, auth, cmp_id, login_id,
        ...
        protected void onPostExecute(String result) {
            ...
            if (null != result && !result.isEmpty()) {
                ...
                Log.e("newproduct", result);
              //  Toast.makeText(Product_edit.this,""+result,Toast.LENGTH_LONG).show();

                try {
                    JSONObject jo = new JSONObject(result);

                    String res = jo.optString("updateproduct");
                    ...
                    if (error.equals("true")){
                        Toast.makeText(Product_edit.this,"Edit Successfully",Toast.LENGTH_LONG).show();

                        Intent i = new Intent(Product_edit.this, Product_List.class);
                        i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        startActivity(i);

                    }else {
                        Toast.makeText(Product_edit.this,"Edit Failed !",Toast.LENGTH_LONG).show();
    ...
    public String CateID(String cateName){
        ...
        if (null != result && !result.isEmpty()) {
            ...
            Toast.makeText(getApplicationContext(), "Sorry cid", Toast.LENGTH_LONG).show();
        }
        return CateId;
    }
    ...
    public String HsnID(String name){
        ...
        if (null != result && !result.isEmpty()) {
            ...
            Toast.makeText(getApplicationContext(), "Sorry hsnid", Toast.LENGTH_LONG).show();
        }
        return Id;
    }
    ...
    public String UnitID(String name){
        ...
        if (null != result && !result.isEmpty()) {
            ...
            Toast.makeText(getApplicationContext(), "Sorry unitid", Toast.LENGTH_LONG).show();
        }
        return Id;
    }
    ...
    public String CastID(String name){
        ...
        if (null != result && !result.isEmpty()) {
            ...
            Toast.makeText(getApplicationContext(), "Sorry cast id", Toast.LENGTH_LONG).show();
        }
        return Id;
    }
    ...
    public String HsnRate(String name){
        ...
        if (null != result && !result.isEmpty()) {
            ...
            Toast.makeText(getApplicationContext(), "Sorry hsn rate", Toast.LENGTH_LONG).show();
        }
        return Id;
    }
