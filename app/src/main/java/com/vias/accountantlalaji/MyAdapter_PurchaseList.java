...
public class MyAdapter_PurchaseList extends RecyclerView.Adapter<MyAdapter_PurchaseList.ViewHolder> {
    ...
    public MyAdapter_PurchaseList(List<SaleList_Listitem> saleList_listitems, Context context) {
    ...
    @Override
    public MyAdapter_PurchaseList.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.cardview_sale_list, parent, false);
        return new MyAdapter_PurchaseList.ViewHolder(v);

    }

    @Override
    public void onBindViewHolder(final MyAdapter_PurchaseList.ViewHolder holder, final int position) {
        ...
        holder.cardview_sale.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, BillView_purhase.class);
