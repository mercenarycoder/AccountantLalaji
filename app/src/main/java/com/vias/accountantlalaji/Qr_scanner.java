...
public class Qr_scanner extends AppCompatActivity implements BarcodeReader.BarcodeReaderListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        qr_code_scanner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(Qr_scanner.this,Qr_scanner.class);
                startActivity(i);
            }
        });
        ...
        expenses_LL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(Qr_scanner.this,Expenses_Activity.class);
                startActivity(i);
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Qr_scanner.this, Setting.class);
                startActivity(i);
        ...
        support.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Qr_scanner.this, Support.class);
                startActivity(i);
        ...
        ((ImageView)findViewById(R.id.messengerImg)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* Uri uri = Uri.parse("fb-messenger://user/100005727832736");
                ...
                {
                    Toast.makeText(Qr_scanner.this, "Please Install Facebook Messenger",    Toast.LENGTH_LONG).show();
                }*/
                ...
                {
                    //Toast.makeText(Qr_scanner.this,                           "Oups! Can't open Facebook messenger app right now.",                             Toast.LENGTH_SHORT).show();
                    String url = "https://www.facebook.com/accountantlalaji/";
                    Intent i = new Intent(Intent.ACTION_VIEW);
                    i.setData(Uri.parse(url));
                    startActivity(i);
        ...
        qr_text = (TextView) findViewById(R.id.qr_text);
    ...
    public void onScanned(Barcode barcode) {
        ...
        try {
            ...
            Intent intent=new Intent(Qr_scanner.this,Qr_WebsiteView.class);
...
//Toast.makeText(Qr_scanner.this,"Some other format qr code readen",Toast.LENGTH_SHORT).show();
    ...
    private class SetupDrawerData extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            progressDialog = new ProgressDialog(Qr_scanner.this);
