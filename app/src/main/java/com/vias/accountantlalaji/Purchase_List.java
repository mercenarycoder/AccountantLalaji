...
public class Purchase_List extends AppCompatActivity {
    ...
    LinearLayout tab_salelistLL, tab_productlistLL, tab_contactlistLL, tab_reportlistLL;
    Button purchaseBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        purchaseViewMore = (TextView)findViewById(R.id.purchaseViewMore);
        ...
        tab_salelistLL = (LinearLayout)findViewById(R.id.ptab_salelistLL) ;
        tab_productlistLL = (LinearLayout)findViewById(R.id.ptab_productlistLL) ;
        tab_contactlistLL = (LinearLayout)findViewById(R.id.ptab_contactlistLL) ;
        tab_reportlistLL = (LinearLayout)findViewById(R.id.ptab_reportlistLL) ;
        ...
        qr_code_scanner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(Purchase_List.this,Qr_scanner.class);
                startActivity(i);
            }
        });
        ...
        expenses_LL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(Purchase_List.this,Expenses_Activity.class);
                startActivity(i);
            }
        });
        ...
        sale_list_left.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (click==1){
                    ...
                    adapterSelect_SaleList = new MyAdapter_PurchaseList(listitems_Salelist, Purchase_List.this);
...
///////////////////////////////////
        ...
        linkLL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                drawerLayoutSaleList.closeDrawers();
                Intent i = new Intent(Purchase_List.this, BillShow.class);
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Purchase_List.this, Profile.class);
                startActivity(i);
        ...
        setting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                drawerLayoutSaleList.closeDrawers();
                Intent i = new Intent(Purchase_List.this, Setting.class);
                startActivity(i);
        ...
        support.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Purchase_List.this, Support.class);
                startActivity(i);
        ...
        ((ImageView)findViewById(R.id.messengerImg)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* Uri uri = Uri.parse("fb-messenger://user/100005727832736");
                ...
                {
                //    Toast.makeText(Purchase_List.this,
...
///////////////////////////////////////
        ...
        purchaseViewMore.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                ScrollView scrollView = (ScrollView) findViewById(R.id.scrollViewPurchase);
    ...
    private class SaleDataList extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(Purchase_List.this);
        ...
        protected String doInBackground(String... strings) {
            ...
            String url = getString(R.string.purchase_list);
        ...
        protected void onPostExecute(String result) {
            ...
            if (null != result && !result.isEmpty()) {
                ...
                try {
                    ...
                    JSONObject jo = (new JSONObject(result)).getJSONObject("purchaselist_data");
                    ...
                    if (response.equals("true")) {
                        ...
                        try {
                           // listitems_Salelist.clear();
                            JSONArray jsonArray = jo.getJSONArray("purchaselist_array");

                            final int numberc = jsonArray.length();
                            if (numberc<10){
                                purchaseViewMore.setVisibility(View.GONE);
                            }else {
                                purchaseViewMore.setVisibility(View.VISIBLE);
    ...
    private class TodaySaleDataList extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            JsonParser jp = new JsonParser();
            String url = getString(R.string.purchase_list_today);
            String auth = getString(R.string.auth_key);
            ...
            if (null != result && !result.isEmpty()) {
                ...
                try {
                    ...
                    if (response.equals("true")) {
                        ...
                        try {
                        //    listitems_Salelist.clear();
                        //    adapterSelect_SaleList = new MyAdapter_SaleList(listitems_Salelist, Purchase_List.this);
                        //    recyclerViewSelect_SaleList.setAdapter(adapterSelect_SaleList);
                        //    todayTotalAmountTV.setText("00");
    ...
    private class YesterdaySaleDataList extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            JsonParser jp = new JsonParser();
            String url = getString(R.string.purchase_list_yesterday);
            String auth = getString(R.string.auth_key);
            ...
            if (null != result && !result.isEmpty()) {
                ...
                try {
                    ...
                    if (response.equals("true")) {
                        ...
                        Picasso.with(Purchase_List.this)
