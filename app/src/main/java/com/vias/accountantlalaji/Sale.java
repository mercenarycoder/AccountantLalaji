...
public class Sale extends AppCompatActivity {
    ...
    EditText cAdd;
    EditText GSTNumber;
    private LinearLayout qr_code_scanner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (ContextCompat.checkSelfPermission(Sale.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)
        {
            if(ActivityCompat.shouldShowRequestPermissionRationale((Activity) Sale.this, Manifest.permission.CAMERA))
            {
                AlertDialog.Builder alertBuilder = new AlertDialog.Builder(Sale.this);
                ...
                alertBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ActivityCompat.requestPermissions((Activity) Sale.this,
                ...
                ActivityCompat.requestPermissions((Activity) Sale.this, new String[]{Manifest.permission.CAMERA}, 0);
            }
        ...
        qr_code_scanner.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i=new Intent(Sale.this,Qr_scanner.class);
                startActivity(i);
            }
        });
        ...
        expenses_LL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i=new Intent(Sale.this,Expenses_Activity.class);
                startActivity(i);
            }
        });
...
/*
        ...
        pText.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            //    BaseInputConnection inputConnection = new BaseInputConnection(pText, true);
             //   inputConnection.sendKeyEvent(new KeyEvent(KeyEvent.KEYCODE_SPACE, KeyEvent.KEYCODE_SPACE));
        ...
        barcodeScan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Sale.this, ScanActivity.class);
            ...
            public void onClick(View v) {
                ...
                if (cusID != null && !cusID.isEmpty() && !cusID.equals("null")) {
                    if (listitems_Select_Product != null && !listitems_Select_Product.isEmpty() && !listitems_Select_Product.equals("null")) {
                        ...
                        Intent i2 = new Intent(getApplicationContext(), Bill.class);
                        startActivity(i2);
                        finish();
...
///////////////////////////////////
        ...
        linkLL.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                drawerLayoutSaleList.closeDrawers();
                Intent i = new Intent(Sale.this, BillShow.class);
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Sale.this, Profile.class);
                startActivity(i);
        ...
        setting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                drawerLayoutSaleList.closeDrawers();
                Intent i = new Intent(Sale.this, Setting.class);
                startActivity(i);
        ...
        support.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(Sale.this, Support.class);
                startActivity(i);
        ...
        ((ImageView)findViewById(R.id.messengerImg)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
               /* Uri uri = Uri.parse("fb-messenger://user/250606038789056");
...
///////////////////////////////////////
    ...
    private class SaleData extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            String url = getString(R.string.saledata);
                ...
                try {
                    ...
                    if (response.equals("true")) {
                        ...
                        try {
                            ...
                            AutoCompeleteAdapter_Customer adapter = new AutoCompeleteAdapter_Customer(Sale.this, customerLists);
                            ...
                            AutoCompeleteAdapter_Product adapterP = new AutoCompeleteAdapter_Product(Sale.this, productLists);
                        ...
                        Snackbar snackbar = Snackbar.make(saleRL, error_response, Snackbar.LENGTH_LONG);
                        snackbar.show();
    ...
    private class SignupJson extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (null != result && !result.isEmpty()) {
                ...
                try {
                    ...
                    if (response.equals("true")) {
                        ...
                        Snackbar snackbar = Snackbar
                                .make(saleRL, "Customer Created", Snackbar.LENGTH_LONG);
                        snackbar.show();
                ...
                Toast.makeText(Sale.this, "Something went wrong ! ", Toast.LENGTH_LONG).show();
            }
        }
    }
